    ...
    return (
      <div className="relative min-h-screen overflow-hidden bg-slate-950 px-4 text-white">
        <div className="pointer-events-none absolute inset-0" aria-hidden="true">
          ...
          <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(148,163,184,0.08)_1px,transparent_1px),linear-gradient(0deg,rgba(148,163,184,0.08)_1px,transparent_1px)] bg-[size:140px_140px] opacity-30 animate-[pulse_10s_ease-in-out_infinite]" />
          <div className="absolute -top-32 left-0 h-80 w-full bg-[conic-gradient(from_180deg_at_50%_50%,rgba(56,189,248,0.12),rgba(168,85,247,0.15),rgba(15,23,42,0))] blur-2xl opacity-80 animate-[pulse_14s_ease-in-out_infinite]" />
          <div className="absolute -bottom-24 left-0 h-64 w-full bg-[conic-gradient(from_0deg_at_50%_50%,rgba(14,165,233,0.12),rgba(99,102,241,0.2),rgba(15,23,42,0))] blur-2xl opacity-70 animate-[pulse_16s_ease-in-out_infinite]" />
          <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(15,23,42,0.6),rgba(2,6,23,0.95))]" />
        </div>

        <div className="relative mx-auto flex min-h-screen max-w-6xl flex-col items-center justify-center gap-12 py-16 text-center lg:flex-row lg:text-left">
          <div className="flex w-full max-w-xl flex-col items-center gap-6 lg:items-start">
            ...
            <div className="space-y-5">
              ...
              <p className="text-sm text-slate-400">{t("landing.heroPitch")}</p>
            </div>
          ...
          <div className="w-full max-w-xl space-y-6">
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6 text-left shadow-2xl shadow-black/40 backdrop-blur">
              <p className="text-xs font-semibold uppercase tracking-[0.3em] text-cyan-200/80">
                {t("landing.sectionInside")}
              </p>
              <div className="mt-4 grid gap-4 sm:grid-cols-2">
                ...
                <div className="rounded-2xl border border-white/10 bg-slate-950/40 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-400">
                    {t("landing.featureStatsBody")}
                  </p>
                </div>
                <div className="rounded-2xl border border-white/10 bg-slate-950/40 p-4">
                  <p className="text-base font-semibold text-white">
                    {t("landing.featureFlowTitle")}
                  </p>
                  <p className="mt-2 text-sm text-slate-400">
                    {t("landing.featureFlowBody")}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6 text-left shadow-2xl shadow-black/40 backdrop-blur">
              <p className="text-xs font-semibold uppercase tracking-[0.3em] text-purple-200/80">
                {t("landing.sectionImpact")}
              </p>
              <ul className="mt-4 space-y-3 text-sm text-slate-300">
                <li className="flex items-start gap-3">
                  <span className="mt-1 h-2 w-2 rounded-full bg-cyan-300 shadow-[0_0_10px_rgba(34,211,238,0.7)]" />
                  <span>{t("landing.impactLineOne")}</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-1 h-2 w-2 rounded-full bg-purple-300 shadow-[0_0_10px_rgba(196,181,253,0.6)]" />
                  <span>{t("landing.impactLineTwo")}</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-1 h-2 w-2 rounded-full bg-indigo-300 shadow-[0_0_10px_rgba(129,140,248,0.6)]" />
                  <span>{t("landing.impactLineThree")}</span>
                </li>
              </ul>
            </div>
          </div>

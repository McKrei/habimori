...
- Пока таймер активен, каждую минуту показывается краткое уведомление, проигрывается звук около 2 секунд и (при разрешении) отправляется системное уведомление (через Service Worker, может зависеть от ограничений фонового режима браузера).

...
- При активном таймере доступна кнопка настройки «помидора» (Pomodoro); можно включать/выключать уведомления и звук, рядом отображается обратный отсчёт фазы Фокус/Отдых, если режим включён.
